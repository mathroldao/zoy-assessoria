...
# ======================================================
    ...
    if st.session_state.get("show_new_creator", False):
    ...
    with right:
        ...
        if st.session_state.get("deleting_creator") == selected_creator:
        ...
        if st.session_state.get("editing_creator") == selected_creator:
                ...
                with st.form("form_edit_creator"):
                    ...
                    with col2:
                        ...
                        edit_status = st.selectbox(
                            ...
                            index=["Ativo", "Pausado", "Encerrado"].index(creator.get("status", "Ativo"))
                            if creator.get("status", "Ativo") in ["Ativo", "Pausado", "Encerrado"] else 0
                        )
...
path = Path("/mnt/data/app_zoy_assessoria_v3.py")
